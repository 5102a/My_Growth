...
![BFC自适应左右布局1](img/BFC自适应左右布局1.png)

亦或者是这样

![BFC自适应左右布局2](img/BFC自适应左右布局2.png)

当然还有更多花样

![BFC自适应左右布局3](img/BFC自适应左右布局3.gif)
...
![浮动与absolute](img/浮动与absolute.gif)
